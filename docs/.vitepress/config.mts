      ...
      '/codex/': [
        {
          ...
          items: [
            ...
            { text: '03 codex-core Agent 运行时', link: '/codex/core' },
            { text: '04 模型与通信协议', link: '/codex/model-protocol' },
            { text: '05 工具系统与文件修改', link: '/codex/tools' },
            { text: '06 审批与跨平台沙箱', link: '/codex/sandbox' },
            { text: '07 会话、历史与状态', link: '/codex/state' },
            { text: '08 App Server 与多端接入', link: '/codex/app-server' },
            { text: '09 MCP、插件与 Skills', link: '/codex/extensions' },
            { text: '10 Python 与 TypeScript SDK', link: '/codex/sdk' },
            { text: '11 构建、测试与发布', link: '/codex/build-release' },
            { text: '12 源码阅读实践', link: '/codex/reading' },
          ],
        },
      ],
